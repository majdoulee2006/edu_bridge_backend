...
class AffairsController extends Controller
{
    ...
    public function getStudentAcademicCardForAffairs(Request $request)
    {
        ...
        $summary = StudentAcademicService::getAcademicSummary($student->student_id, $studentYearInt);
        $academicCardData = $summary['academic_card'];
        $average = $summary['average'];
        $passedCount = $summary['passed_courses'];
        $failedCount = $summary['failed_courses'];
        $notAttendedCount = $summary['not_attended'];
