...
@section('content')
    ...
    <!-- Language Settings -->
    <div class="bg-white dark:bg-card-dark rounded-3xl p-5 shadow-soft border border-slate-100 dark:border-slate-800/50 transition-colors">
        <h4 class="text-xs font-bold text-slate-400 dark:text-slate-500 mb-4">اللغة والمنطقة</h4>
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
                <span class="material-symbols-outlined text-slate-400 text-[20px]">language</span>
                <span class="text-sm font-bold text-slate-700 dark:text-slate-200">لغة الواجهة</span>
            </div>
            <div class="flex items-center gap-3">
                <span id="admin-lang-current" class="text-xs text-slate-500 dark:text-slate-400">العربية</span>
                <button onclick="toggleAdminLanguage()" class="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-primary hover:text-primary-content transition-all text-xs font-bold text-slate-600 dark:text-slate-300">
                    <i class="fa-solid fa-globe"></i>
                    <span id="admin-lang-btn-text-settings">EN / عر</span>
                </button>
            </div>
        </div>
    </div>
